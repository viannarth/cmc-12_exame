...
m0 = log([controlador_baseline.theta.Kv, controlador_baseline.theta.Kp, ...
    controlador_baseline.x.Kp, controlador_baseline.x.Ki, ...
    controlador_baseline.x.Kd, controlador_baseline.z.Kp, ...
    controlador_baseline.z.Ki, controlador_baseline.z.Kd]');
